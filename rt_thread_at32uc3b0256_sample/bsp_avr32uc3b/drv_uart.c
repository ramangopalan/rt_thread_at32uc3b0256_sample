...
static struct avr32uc3b_uart_dev uart_dev[] =
{
#ifdef BSP_USING_UART0
    {
        ...
        .tx_pin = AVR32_USART1_TXD_0_1_PIN,
		.tx_pin_function = AVR32_USART1_TXD_0_1_FUNCTION,
        .rx_pin = AVR32_USART1_RXD_0_1_PIN,
		.rx_pin_function = AVR32_USART1_RXD_0_1_FUNCTION,
...
void avr32uc3b_uart1_isr(void)
{
    rt_interrupt_enter();
    /* read interrupt status and clear it */
    if (uart_is_readable(&AVR32_USART2)) /* rx ind */
    {
